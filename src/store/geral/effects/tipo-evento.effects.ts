...
import {catchError, map, switchMap, timeInterval, delay, repeat} from 'rxjs/operators';

import {TipoEventoService} from '../../../app/model/servicos/dao/tipo-evento.service';
...
export class TipoEventoEffects {
  ...
  obtemTipoEventos$ = this._actions$.pipe(
      ...
      switchMap(
          () => this._tipoEventoService.findAllTipoEventos().pipe(
