...
import {DataDeEntregaRestService} from '../../../app/model/servicos/dao/data-de-entrega-rest.service';
...
export class DataDeEntregaEffects {
  ...
  obtemDataDeEntregas$ = this._actions$.pipe(
      ...
      switchMap(
          (action: fromActions.ObtemDatasDeEntregaDisponiveisRun) =>
              this._dataDeEntregaRestService
                  .findDatasDeEntrega(
                      action.payload.ano, action.payload.semestre)
