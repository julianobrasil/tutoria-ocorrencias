...
export class TutoriaService {
  ...
  obtemuTutoriaPorId(): Observable<fromDocuments.Tutoria> {
    return this._http
        .get(URL.baseTutoriaServiceURL + URL.tutoriaPath, {observe: 'response'})
        .pipe(
  ...
  saveTutoria(tutoria: fromDocuments.Tutoria):
    ...
    return this._http
        .post(
            URL.baseTutoriaServiceURL + URL.tutoriaSalvarPath,
  ...
  removeTutoria(id: string): Observable<boolean> {
    return this._http
        .delete(
            URL.baseTutoriaServiceURL + URL.tutoriaRemoverPath + id,
            {observe: 'response'})
        .pipe(
            map(() => {
              return true;
  ...
  findTutoriaByEmailTutorAtivo(emailTutorAtivo?: string):
      Observable<fromDocuments.Tutoria[]> {
    return of(JSON.parse(JSON.stringify(TUTORIAS_EXISTENTES)));
  }
  ...
  findTutoriaByEmailTutorOuCoordenador(
    ...
    if (!!termo) {
      params = params.set(
          URL.tutoriaByEmailTutorOuCoordenadorKey2_nomeOuEmail, termo);
    }
    ...
    if (!!pageSize) {
      params = params.set(
          URL.tutoriaByEmailTutorOuCoordenadorKey3_page, '' + pageSize);
    }
  ...
  findTutoriaByEmailTutorOuCoordenadorOuCurso(
    ...
    params = params.set(
        URL.tutoriaByEmailTutorOuCoordenadorOuCursoKey1_email, email);
    ...
    if (!!page) {
      params = params.set(
          URL.tutoriaByEmailTutorOuCoordenadorOuCursoKey3_page, '' + page);
    }

    if (!!pageSize) {
      params = params.set(
          URL.tutoriaByEmailTutorOuCoordenadorOuCursoKey4_size, '' + pageSize);
    }
  ...
  findTutoriaByPareceristaLogado(): Observable<fromDocuments.Tutoria[]> {
    return this._http
        .get(
            URL.baseTutoriaServiceURL + URL.tutoriaByPareceristaLogadoPath,
            {observe: 'response'})
        .pipe(
            map((res: HttpResponse<any>) => {
              if (res.ok) {
  ...
  findValorTutoriaBySemestreDeTrabalho(
      semestreDeTrabalho: fromDocuments.SemestreDeTrabalho,
      ): Observable<fromDocuments.ValorTutoria[]> {
    return this._http
        .post(
            URL.baseTutoriaServiceURL +
  ...
  findEventoByTutorTipoSubtipoCursoNomeResolvido(
    ...
    if (!!page) {
      params = params.set(
          URL.eventoByTutorTipoSubtipoCursoResolvidoKey3_page, '' + page);
    }

    if (!!pageSize) {
      params = params.set(
          URL.eventoByTutorTipoSubtipoCursoResolvidoKey4_size, '' + pageSize);
    }
  ...
  saveEvento(evento: fromDocuments.Evento): Observable<fromDocuments.Evento> {
    return this._http
        .post(
            URL.baseTutoriaServiceURL + URL.eventoSalvarPath,
  ...
  cutuca(cutucada: fromDocuments.Cutucada): Observable<fromDocuments.Evento> {
    return this._http
        .post(
            URL.baseTutoriaServiceURL + URL.eventoCutucaPath,
