...
import {CONFIG_EXISTENTE} from '../../../../data/config';
...
export class ConfiguracoesService {
  ...
  save(config: Config): Observable<Config> {
    return this.http.post(URL.baseTutoriaServiceURL + URL.configSalvarPath,
  ...
  obtemDataEHoraServidor(): Observable<Date> { return of(new Date()); }
}
