...
import {Evento, TipoVisibilidade, Unidade} from '../../model/transport-objects';
...
export class OcorrenciaFormularioComponent implements AfterViewInit,
  ...
  private _initGeral() {
    combineLatest(
        this._tipoFormulario$.pipe(startWith(this._tipoFormulario),
                                   debounceTime(500), filter(Boolean)),
