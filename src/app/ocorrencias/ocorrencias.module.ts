...
import {OcorrenciaPopoverDeEscolhaComponent} from './lista-de-ocorrencias/ocorrencia-popover-de-escolha/ocorrencia-popover-de-escolha.component';
...
import {LocalEUnidadePipe} from './shared/pipes/local-e-unidade.pipe';
...
@NgModule({
  ...
  entryComponents: [TipoSubtipoDeEventoDialogComponent],
  imports: [
