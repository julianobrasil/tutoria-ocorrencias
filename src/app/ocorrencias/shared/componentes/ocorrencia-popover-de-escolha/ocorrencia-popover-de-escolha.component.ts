...
export class OcorrenciaPopoverDeEscolhaComponent {
  ...
  @Output()
  novaOcorrencia: EventEmitter<OcorrenciaFormularioComponentTipo> = new EventEmitter<
  ...
  _novaOcorrenciaComum(popover: SatPopover) {
    this.novaOcorrencia.emit(OcorrenciaFormularioComponentTipo.OCORRENCIA_COMUM);
    popover.close();
  }
}
